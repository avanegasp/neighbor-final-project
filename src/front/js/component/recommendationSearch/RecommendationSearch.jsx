...
const RecommendationSearch = () => {
    ...
    console.log("usersrecommendationssearch", store.recommendations)
    ...
    //             user.recommendation.name.toLowerCase().startsWith(searchValue.toLowerCase())
    //         );
    ...
    //         (user) => user.recommendation.name.toLowerCase() === search.toLowerCase()
    //     );
