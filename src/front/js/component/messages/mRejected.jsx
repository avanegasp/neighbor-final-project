...
function MRejected() {
    return (
        ...
        >
            <div className="container d-flex flex-column justify-content-center align-items-center bg-dark text-white p-3" style={{ minHeight: "30vh", maxWidth: "400px", textAlign: "center", borderRadius: "10px" }}>
